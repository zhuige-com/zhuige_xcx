	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new ZhuiGe_WxPayException("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new ZhuiGe_WxPayException("xml数据异常！");
		}
        //将XML转为array
        //禁止引用外部xml实体
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
		$string = $string . "&key=".ZhuiGe_WxPayConfig::get_key();
		//签名步骤三：MD5加密
		$string = md5($string);
		//签名步骤四：所有字符转为大写
 ...
 *
 */
class ZhuiGe_WxPayResults extends ZhuiGe_WxPayDataBase
{
	/**
	 * 
	 * 检测签名
	...
	public function CheckSign()
	{
		//fix异常
		if(!$this->IsSignSet()){
			throw new ZhuiGe_WxPayException("签名错误！");
		}
 ...
 *
 */
class ZhuiGe_WxPayNotifyReply extends  ZhuiGe_WxPayDataBase
{
	/**
	 * 
 ...
 *
 */
class ZhuiGe_WxPayUnifiedOrder extends ZhuiGe_WxPayDataBase
{	
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayOrderQuery extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayCloseOrder extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayRefund extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayRefundQuery extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayDownloadBill extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayReport extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayShortUrl extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayMicroPay extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayReverse extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayJsApiPay extends ZhuiGe_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class ZhuiGe_WxPayBizPayUrl extends ZhuiGe_WxPayDataBase
{
		/**
	* 设置微信分配的公众账号ID
	* @param string $value 
