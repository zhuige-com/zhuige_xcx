<template>
	<view class="uni-load-more" @click="onClick">
		...
		:style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-H5">
			<circle class="circle" cx="50" cy="50" r="20" fill="none" :style="{color:color}" :stroke-width="3"></circle>
		</svg>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE || H5 -->
		...
		:style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-MP">
			<view class=".view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
			<view class=".view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
			<view class=".view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
		</view>
		<!-- #endif -->
...
<script>
	 ...
	 * @property {Object} contentText 各状态文字说明，值为：{contentdown: "上拉显示更多",contentrefresh: "正在加载...",contentnomore: "暂无数据哦~"}
